...
class _AdminScreenState extends State<AdminScreen>
  ...
  Future<void> _showCreatePatientDialog() async {
    ...
    final paternalCtrl      = TextEditingController();
    final maternalCtrl      = TextEditingController();
    ...
    if (result == true) {
      try {
        final data = await _patientService.createPatient(
          firstName:       firstNameCtrl.text.trim(),
          paternalSurname: paternalCtrl.text.trim(),
          maternalSurname: maternalCtrl.text.trim().isEmpty ? null : maternalCtrl.text.trim(),
        );
        await _loadPatients();
        if (!mounted) return;
        final Patient patient = data['patient'] as Patient;
        final String username    = data['username'] as String;
        final String tempPassword = data['tempPassword'] as String;
        ...
        showDialog(
          ...
          builder: (_) => AlertDialog(
            ...
            content: Column(
              ...
              children: [
                Text('Comparte estas credenciales con ${patient.fullName}:',
                    style: TextStyle(fontWeight: FontWeight.w500)),
                SizedBox(height: 12),
                _credRow(Icons.person, 'Usuario', username),
                _credRow(Icons.lock_outline, 'Contraseña temporal', tempPassword),
                SizedBox(height: 8),
                Text('El paciente deberá cambiar su contraseña al primer inicio de sesión.',
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Flexible(child: Text(value, style: TextStyle(fontFamily: 'monospace'))),
        ],
      ),
    );
  }
